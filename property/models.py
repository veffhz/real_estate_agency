...
class Flat(models.Model):
    ...
    new_building = models.NullBooleanField("Признак новостройки", db_index=True)

    likes = models.ManyToManyField(User, verbose_name="Кто лайкнул", related_name="flats")
...
class Claim(models.Model):
    user = models.ForeignKey(
        User, verbose_name="Кто жаловался", related_name="claims", on_delete=models.CASCADE
    )

    flat = models.ForeignKey(
        Flat, verbose_name="Квартира, на которую жаловались", related_name="claims", on_delete=models.CASCADE
    )
